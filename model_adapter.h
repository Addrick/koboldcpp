...
int get_target_slot(int excludeSlotA, int excludeSlotB);    //where to write: free slot, else oldest
int get_evictable_slot(int excludeSlotA, int excludeSlotB); //what to free: oldest NON-EMPTY slot, or -1
